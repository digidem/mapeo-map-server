declare module '@maplibre/maplibre-gl-style-spec' {
   ...
   */
  export function format(style: any, space?: number): string
  /**
   ...
   * @returns {Array<Layer>}
   */
  export function derefLayers(layers: any): any
  ...
  function isExpression(expression: unknown): boolean
  function createExpression(
    expression: unknown,
    propertySpec?: StylePropertySpecification | null
  ): Result<StyleExpression, Array<ExpressionParsingError>>
  class ZoomConstantExpression<Kind extends EvaluationKind> {
    kind: Kind
  ...
  class ZoomDependentExpression<Kind extends EvaluationKind> {
    kind: Kind
  ...
  function normalizePropertyExpression<T>(
  ...
  function eachSource(
    ...
    callback: (_: SourceSpecification) => void
  ): void
  function eachLayer(
    style: StyleSpecification,
    callback: (_: LayerSpecification) => void
  ): void
      ...
      paint_line: {
        ...
        'line-dasharray': {
          ...
          'sdk-support': {
            ...
            // https://github.com/maplibre/maplibre-gl-js/blob/bf66f4e4a5a8aca0245f3b53b54506f12e7734e2/src/style-spec/reference/v8.json#L4527
            'data-driven styling': Record<string, never>
          }
          expression: {
            interpolated: boolean
            parameters: string[]
        ...
        'line-gradient': {
          ...
          'sdk-support': {
            ...
            // https://github.com/maplibre/maplibre-gl-js/blob/bf66f4e4a5a8aca0245f3b53b54506f12e7734e2/src/style-spec/reference/v8.json#L4589
            'data-driven styling': Record<string, never>
          }
          expression: {
            interpolated: boolean
      ...
      paint_heatmap: {
        ...
        'heatmap-color': {
          ...
          'sdk-support': {
            ...
            // https://github.com/maplibre/maplibre-gl-js/blob/bf66f4e4a5a8aca0245f3b53b54506f12e7734e2/src/style-spec/reference/v8.json#L5043
            'data-driven styling': Record<string, never>
          }
          expression: {
            interpolated: boolean
      ...
      paint_background: {
        ...
        'background-pattern': {
          ...
          'sdk-support': {
            ...
            // https://github.com/maplibre/maplibre-gl-js/blob/bf66f4e4a5a8aca0245f3b53b54506f12e7734e2/src/style-spec/reference/v8.json#L5904
            'data-driven styling': Record<string, never>
          }
          expression: {
            interpolated: boolean
  ...
  export type ExpressionType =
    ...
    | 'data-constant'
    | 'constant'
  export type ExpressionParameters = Array<
    'zoom' | 'feature' | 'feature-state' | 'heatmap-density' | 'line-progress'
  >
  ...
  export type StylePropertySpecification =
    ...
    | {
        ...
        expression?: ExpressionSpecification
        values: {
          // https://github.com/mapbox/mapbox-gl-js/blob/83b8d8fb690a9fd1a9eef558d425725679287887/src/style-spec/style-spec.js#L34
          [_: string]: Record<string, never>
        }
        transition: boolean
        default?: string
      }
